-- ==========================================================
-- UPDATE T+1 QR PAYMENT COMMISSION FOR DISTRIBUTORS & MASTER DISTRIBUTORS
-- This script updates approve_qr_payment so that T+1 payments also
-- distribute commission to Distributors and Master Distributors (Super Distributors).
-- ==========================================================
