...
}`,s),s=d(s,130),t.setFont("helvetica","bold"),t.setFontSize(10),t.setTextColor(16,185,129),t.text("2.6 GET /status/:transaction_id - Check Live Status & Auto-Refund",14,s),s+=4,t.setFont("helvetica","normal"),t.setFontSize(8),t.setTextColor(71,85,105),t.text("Pass BBPSU1283118228, TXN_ORD..., or CC01... ID. Pending transactions without CC01 ID auto-fail and auto-refund.",14,s),s+=5,s=n("Sample Success Response (200 OK)",`{
  "status": "success",
  "data": {
    "transaction_id": "BBPSU1283118228",
    "client_transaction_id": "TXN_ORD_20260814_001",
...
}`})]}),e.jsxs("div",{className:"bg-slate-800/80 rounded-2xl border border-slate-700 p-6 shadow-xl space-y-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute top-0 right-0 p-36 bg-emerald-500/5 blur-[120px] rounded-full pointer-events-none"}),e.jsxs("div",{className:"flex items-center justify-between border-b border-slate-700/80 pb-3 relative z-10",children:[e.jsxs("h3",{className:"text-lg font-bold text-white flex items-center gap-3",children:[e.jsx("span",{className:"bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 px-2.5 py-1 rounded-md text-xs uppercase font-extrabold tracking-wider",children:"GET"}),"/status/:transaction_id"]}),e.jsx("span",{className:"text-xs text-slate-400 font-mono font-semibold",children:"Check Live Status"})]}),e.jsxs("p",{className:"text-xs text-slate-300 leading-relaxed relative z-10",children:["Check live transaction status by passing your API Transaction ID (e.g. ",e.jsx("code",{children:"BBPSU1283118228"}),"), your Custom Client Transaction ID (e.g. ",e.jsx("code",{children:"TXN_ORD_20260814_001"}),"), or BillAvenue Ref ID (e.g. ",e.jsx("code",{children:"CC01..."}),")."]}),e.jsxs("div",{className:"bg-indigo-950/40 border border-indigo-500/30 rounded-xl p-4 space-y-2 relative z-10",children:[e.jsxs("div",{className:"flex items-center gap-2 text-indigo-300 font-bold text-xs",children:[e.jsx(B,{className:"h-4 w-4 text-indigo-400"}),e.jsx("span",{children:"Automatic Gateway Failure & Auto-Refund Policy"})]}),e.jsxs("p",{className:"text-[11px] text-slate-300 leading-normal",children:["If a transaction status is ",e.jsx("code",{children:"pending"})," and no ",e.jsx("code",{children:"CC01"})," Reference ID was generated (e.g. gateway socket error or network drop before hitting biller gateway), calling ",e.jsx("code",{children:"/status/:transaction_id"})," automatically updates local database status to ",e.jsx("code",{children:"failed"})," and performs an ",e.jsx("strong",{children:"Immediate Automatic Refund"})," back to your B2B Agent Wallet balance."]})]}),e.jsx(a,{title:"Sample Success Response (200 OK)",section:"status_res_code",code:`{
  "status": "success",
  "data": {
    "transaction_id": "BBPSU1283118228",
    "client_transaction_id": "TXN_ORD_20260814_001",
