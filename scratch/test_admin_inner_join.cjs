...
async function run() {
  console.log('--- Simulating Admin Inner Join Query ---');
  ...
  if (error) {
    console.error('Inner Join Query Failed:', error);
  } else {
    console.log('Inner Join Query Succeeded! Count of rows received:', data.length);
