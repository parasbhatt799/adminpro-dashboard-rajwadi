...
const getBankLogoUrl = (bankName: string) => {
  ...
  else if (name.includes("csb")) domain = "csb.co.in";
  ...
  else if (name.includes("indian bank") || name.includes("indianbank")) domain = "indianbank.in";
  ...
  else if (name.includes("punjab") || name.includes("pnb")) domain = "pnbindia.in";
  ...
  else if (name.includes("south indian")) domain = "southindianbank.com";
  else if (name.includes("suryoday")) domain = "suryodaybank.com";
  else if (name.includes("union bank")) domain = "unionbankofindia.co.in";
