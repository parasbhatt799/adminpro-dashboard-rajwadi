...
import { Receipt, Search, IndianRupee, RotateCcw, Download } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 mt-1">Generate and export reports for all bill payments.</p>
      </div>
