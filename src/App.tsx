...
export default function App() {
  ...
  const renderAdminContent = () => {
    switch (activeTab) {
      ...
      case 'service-charge':
        return <ServiceChargeManagement />;
      case 'qr-payment-requests':
        return <QRPaymentRequests />;
      case 'bill-payment-requests':
        return <BillPaymentRequests />;
      case 'kyc-verification-requests':
        return <KYCVerificationRequests />;
      case 'reason-entry':
        ...
        return (
          <div className="flex flex-col items-center justify-center h-[60vh] text-slate-400">
            ...
            <p className="mt-2 text-center max-w-xs">
              The <span className="font-bold text-indigo-600 capitalize">{activeTab.replace('-', ' ')}</span> page is currently being designed and will be available soon.
            </p>
          </div>
        );
    }
                ...
                <main className="flex-1 flex flex-col h-screen overflow-hidden">
                  ...
                  <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                      <button 
                        onClick={() => setActiveTab('kyc-verification-requests')}
